...
public class CoreConfig {
  ...
  public static class CorePTAConfiguration {
     ...
     * of classes needed. FULL: load all &lt;clinit&gt; of classes that are currently loaded in the
     * scene. ON_THE_FLY: we load &lt;clinit&gt; on the fly, this mode is same as DOOP (default
     * mode).
     */
    ...
    /**
     * the type of array element is java.lang.Object by default. if set to be true, we will use more
     * precise type for array elements.
     */
     ...
     *
     * <p>This imprecision does not seem to matter too much for typical programs in the
     * context-insensitive and 1-call-site-sensitive analyses, but is disastrous in the
     * 1-object-sensitive analysis.
     *
     * <p>once this switch is open, it will model exception flow-sensitively (same as the precise
     * version in Doop). Implicitly thrown exceptions are not included.
     */
